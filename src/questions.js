...
const questionSets = [
    [
        ...
        { question: "In a given year, how often are you asked to complete surveys (regardless of whether or not you choose to complete them)?", type: "multiple choice", options: ["Never", "Rarely", "Sometimes", "Often", "Always"] },
        { question: "In a given year, out of all the surveys you are asked to take, how many of them do you complete?", type: "multiple choice", options: ["None", "A few", "Some", "Most", "All"] },
        ...
        { question: "When you are asked to take surveys, where do the requests to take these surveys usually come from (check all that apply)?", type: "multiple choice", options: ["Work", "School", "Social media", "Friends/Family", "Companies", "Other (specify)"] },
        { question: "When you choose to take surveys, where do the requests to take these surveys usually come from (select all that apply)?", type: "multiple choice", options: ["Work", "School", "Social media", "Friends/Family", "Other (specify)"] },
        { question: "When you are asked to take a survey, what factors influence your decision to take, or not to take, the survey (select as many as apply)?", type: "multiple choice", options: ["Time constraints", "Being paid to take a survey", "My interest in the survey topic", "My connections to the people running the survey", "A feeling of obligation to contribute to the survey data", "Other (specify)"] },
        ...
        { question: "Do you ever make surveys to send out to other people?", type: "multiple choice", options: ["Never", "Rarely", "Sometimes", "Often", "Always"] }
    ],
    [
        ...
        { question: "Please rate how much you prefer the following type of survey question: yes/no questions", type: "multiple choice", options: ["Strongly disprefer", "Disprefer", "Neutral", "Prefer", "Strongly prefer"] },
        { question: "Please rate how much you prefer the following type of survey question: questions that ask you to respond on a scale of 'strongly disagree' to 'strongly agree'", type: "multiple choice", options: ["Strongly disprefer", "Disprefer", "Neutral", "Prefer", "Strongly prefer"] },
        { question: "Please rate how much you prefer the following type of survey question: multiple choice questions", type: "multiple choice", options: ["Strongly disprefer", "Disprefer", "Neutral", "Prefer", "Strongly prefer"] },
        { question: "Please rate how much you prefer the following type of survey question: free response", type: "multiple choice", options: ["Strongly disprefer", "Disprefer", "Neutral", "Prefer", "Strongly prefer"] },
        ...
        { question: "I feel more engaged when taking aesthetically pleasing surveys.", type: "multiple choice", options: ["Strongly disagree", "Disagree", "Neutral", "Agree", "Strongly agree"] }
    ],
    [
        { question: "Have you ever abandoned a survey? If so, why?", type: "short answer", options: [] },
        { question: "Are you ever concerned about the privacy of your survey responses?", type: "short answer", options: [] },
        ...
        { question: "Does your level of trust in a survey depend on the type of organization conducting the survey (e.g., academic, government, commercial)?", type: "short answer", options: [] },
        { question: "Do you ever feel fatigued while completing and/or after completing a survey? If so, what factors contribute to this fatigue?", type: "short answer", options: [] },
